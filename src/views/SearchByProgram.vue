<template>
  <v-main class="text-center">
    <v-radio-group inline v-model="viewState.program">
      <template v-for="course in dataStore.getUniquePrograms()">
...
<script>
  import { dataStore, searchByProgramStore } from '@/stores'
  ...
  export default {
    ...
    data() {
      return {
        dataStore: dataStore(),
        viewState: searchByProgramStore()
      }
    },
    watch: {
      "viewState.program" () {
